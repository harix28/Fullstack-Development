...
export default function Notifications() {
  const notifications = [
    { id: 1, type: 'scheme', title: 'Scheme Deadline Approaching', message: 'The PM Kisan scheme application closes in 5 days.', unread: true, time: '2 hours ago', icon: <FileText className="text-brand-teal h-5 w-5" /> },
    { id: 2, type: 'job', title: 'New Job Match', message: 'SSC Junior Assistant matches your profile (85%).', unread: true, time: '1 day ago', icon: <Briefcase className="text-blue-500 h-5 w-5" /> },
    { id: 3, type: 'system', title: 'Profile Updated', message: 'Your Aadhaar document was successfully verified.', unread: false, time: '3 days ago', icon: <AlertCircle className="text-green-500 h-5 w-5" /> },
  ];
