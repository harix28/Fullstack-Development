  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border-2 border-dashed border-gray-300 rounded-lg p-12 text-center hover:bg-gray-50 transition-colors cursor-pointer">
        ...
        <h3 className="mt-2 text-sm font-medium text-gray-900">Drag and drop to upload</h3>
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          {/* Document Card 1 */}
          <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm relative group">
            <div className="absolute top-4 right-4 text-green-500" title="Verified">
              <CheckCircle className="h-5 w-5" />
            </div>
            <div className="h-12 w-12 rounded-lg bg-blue-50 flex items-center justify-center mb-4">
              <FileText className="h-6 w-6 text-blue-600" />
            </div>
            <h4 className="font-medium text-brand-navy">Aadhaar Card</h4>
            <p className="text-xs text-gray-500 mb-4">Identity • Uploaded Oct 12</p>
          ...
          {/* Document Card 2 */}
          <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm relative group">
            <div className="absolute top-4 right-4 text-brand-warning" title="Processing">
              <Clock className="h-5 w-5" />
            </div>
            <div className="h-12 w-12 rounded-lg bg-purple-50 flex items-center justify-center mb-4">
              <FileText className="h-6 w-6 text-purple-600" />
            </div>
            <h4 className="font-medium text-brand-navy">Degree Certificate</h4>
            <p className="text-xs text-gray-500 mb-4">Education • Processing OCR</p>
            <div className="flex gap-2">
              <Button variant="outline" size="sm" className="w-full text-xs h-8">View</Button>
            </div>
          </div>
