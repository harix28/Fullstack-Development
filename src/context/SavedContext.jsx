...
export const SavedProvider = ({ children }) => {
    ...
    const toggleSaveScheme = useCallback((id, title) => {
        let nowSaved = false;
    ...
    const toggleSaveJob = useCallback((id, title) => {
        let nowSaved = false;
        setSavedJobIds(prev => {
            if (prev.includes(id)) {
                nowSaved = false;
    ...
    const toggleSaveService = useCallback((id, title) => {
        let nowSaved = false;
    ...
    const isSchemeSaved = useCallback((id) => savedSchemeIds.includes(id), [savedSchemeIds]);
    const isJobSaved = useCallback((id) => savedJobIds.includes(id), [savedJobIds]);
    const isServiceSaved = useCallback((id) => savedServiceIds.includes(id), [savedServiceIds]);
    return (<SavedContext.Provider value={{
            savedSchemeIds,
            savedJobIds,
            savedServiceIds,
            toggleSaveScheme,
